...
{
    static SistemaClima _cache;   // evita FindFirstObjectByType en cada llamada periódica

    public static SistemaClima.EstadoClima EstadoActual
    {
        get
        {
            if (_cache == null)   // null real o destruido (Unity fake-null)
                _cache = Object.FindFirstObjectByType<SistemaClima>();
            return _cache != null ? _cache.climaActual : SistemaClima.EstadoClima.Sol;
        }
    }
}
