...
#pragma warning restore CS0414
    ...
    IEnumerator Start()
    {
        // Esperar al suelo definitivo vía servicio (mosaico: anillo 0 listo).
        // La orto cruza tiles de los anillos 0-1: las alturas de los vértices
        // se toman con TerrenoGlobal.AlturaMundo (tile-aware), no activeTerrain.
        float tEspera = 0f;
        while (tEspera < 60f)
        {
    ...
    // Tile-aware (mosaico V2): GeoDataAlsasua.AlturaTerreno cacheaba activeTerrain,
    // que con 48 tiles devuelve alturas erróneas fuera de su tile.
    static float AlturaTerreno(Vector3 pos) => TerrenoGlobal.AlturaMundo(pos);
