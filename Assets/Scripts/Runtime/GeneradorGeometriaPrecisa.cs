...
public class GeneradorGeometriaPrecisa : MonoBehaviour
{
    ...
    void GenerarTejado(GameObject parent, Vector2[] footprint, float y, EdificioData ed)
    {
        ...
        // ── RUTA 2: GeneradorTejadosAAA (kit modular: gabled/hipped según
        //    OSM roof:shape > catastro > arquetipo). Integrado 2026-06 —
        //    el generador existía pero nunca estaba cableado.
        if (GeneradorTejadosAAA.Instance != null)
        {
            GeneradorTejadosAAA.Instance.GenerarTejadoParaEdificio(parent, footprint, y, 0f, ed);
            return;
        }
