...
public class InterioresExplorables : MonoBehaviour
{
    ...
    void AmueblarSala(Transform raiz, string tipo, float ancho, float fondo)
    {
        switch (tipo)
        {
            ...
            case "TABERNA":
                ...
                for (int i = 0; i < 4; i++)
                    _ = Mueble(raiz, "Silla", new Vector3(-ancho*0.25f + i*1.4f, 0f, fondo*0.0f), 180f, 1f)
            ...
            case "COMISARIA":
                _ = Mueble(raiz, "Escritorio", new Vector3(0, 0f, fondo*0.25f), 0f, 1f)
                ...
                _ = Mueble(raiz, "Banco", new Vector3(0, 0f, -fondo*0.3f), 0f, 1f)
            ...
            case "TIENDA_MISION":
                for (int i = 0; i < 3; i++)
                    _ = Mueble(raiz, "Estante", new Vector3(-ancho*0.3f + i*ancho*0.3f, 0f, fondo*0.25f), 0f, 1f)
            ...
            default: // AYUNT, residencial u otros → salón completo
                _ = Mueble(raiz, "Sofa", new Vector3(-ancho*0.18f, 0f, fondo*0.18f), 90f, 1f)
    ...
    {
        _ = Mueble(raiz, "Lampara", new Vector3(0, 2.9f, 0), 0f, 1f)
    ...
    void AnadirLuzInterior(Transform raiz, Vector3 posMundo, string tipo)
    {
        ...
        hd.SetIntensity(3000f, UnityEngine.Rendering.LightUnit.Lux);
    }
