...
using Unity.Cinemachine;   // Cinemachine 3.x: namespace renombrado (era 'Cinemachine' en 2.x)
#endif
    ...
    public partial class StarterAssetsDeployMenu : ScriptableObject
    {
            ...
            GameObject cinemachineVirtualCamera)
        {
            var serializedObject =
                new SerializedObject(cinemachineVirtualCamera.GetComponent<CinemachineCamera>());   // CM 3.x: CinemachineVirtualCamera → CinemachineCamera
