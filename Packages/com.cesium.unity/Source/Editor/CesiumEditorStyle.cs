...
namespace CesiumForUnity
{
    public static class CesiumEditorStyle
    {
        ...
        private static Texture2D LoadImage(string resourcePath)
        {
            ...
            // NOTA (parche local 2026-06-03): en Unity 6 algunos recursos del editor de
            // Cesium no se cargan y 'icon' queda null. Sin esta guarda, la línea siguiente
            // lanzaba NullReferenceException DENTRO del type-initializer de CesiumEditorStyle,
            // que .NET re-lanza en cada acceso → cascada de cientos de errores por repintado.
            // Fallback no-null para no romper la GUI ni reintroducir spam de "null texture".
            if (icon == null)
