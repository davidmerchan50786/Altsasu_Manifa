    ...
    public partial class CesiumBingMapsRasterOverlay : System.IDisposable
    {
        ...
        protected override partial void AddToTileset(CesiumForUnity.Cesium3DTileset tileset)
        {
            unsafe
            {
                ...
                DotNet_CesiumForUnity_CesiumBingMapsRasterOverlay_AddToTileset(Reinterop.ObjectHandleUtility.CreateHandle(this), _implementation, Reinterop.ObjectHandleUtility.CreateHandle(tileset), &reinteropException);
        ...
        protected override partial void RemoveFromTileset(CesiumForUnity.Cesium3DTileset tileset)
        {
            unsafe
            {
                ...
                System.IntPtr reinteropException = System.IntPtr.Zero;
                DotNet_CesiumForUnity_CesiumBingMapsRasterOverlay_RemoveFromTileset(Reinterop.ObjectHandleUtility.CreateHandle(this), _implementation, Reinterop.ObjectHandleUtility.CreateHandle(tileset), &reinteropException);
                if (reinteropException != IntPtr.Zero) throw (System.Exception)Reinterop.ObjectHandleUtility.GetObjectAndFreeHandle(reinteropException);
            }
        }
        ...
        [DllImport("CesiumForUnityNative", CallingConvention=CallingConvention.Cdecl)]
        private static unsafe extern void DotNet_CesiumForUnity_CesiumBingMapsRasterOverlay_AddToTileset(System.IntPtr thiz, CesiumForUnity.CesiumBingMapsRasterOverlay.ImplementationHandle implementation, System.IntPtr tileset, System.IntPtr* reinteropException);
        [DllImport("CesiumForUnityNative", CallingConvention=CallingConvention.Cdecl)]
        private static unsafe extern void DotNet_CesiumForUnity_CesiumBingMapsRasterOverlay_RemoveFromTileset(System.IntPtr thiz, CesiumForUnity.CesiumBingMapsRasterOverlay.ImplementationHandle implementation, System.IntPtr tileset, System.IntPtr* reinteropException);
    }
}
#endif
