    ...
    public partial class SelectIonTokenWindow : System.IDisposable
    {
        ...
        public partial void RefreshTokens()
        {
            unsafe
            {
                ...
                DotNet_CesiumForUnity_SelectIonTokenWindow_RefreshTokens(Reinterop.ObjectHandleUtility.CreateHandle(this), _implementation, &reinteropException);
        ...
        private partial void CreateToken()
        {
            unsafe
            {
                ...
                System.IntPtr reinteropException = System.IntPtr.Zero;
                DotNet_CesiumForUnity_SelectIonTokenWindow_CreateToken(Reinterop.ObjectHandleUtility.CreateHandle(this), _implementation, &reinteropException);
                if (reinteropException != IntPtr.Zero) throw (System.Exception)Reinterop.ObjectHandleUtility.GetObjectAndFreeHandle(reinteropException);
            }
        }
        private partial void UseExistingToken()
        {
            unsafe
            {
                ...
                System.IntPtr reinteropException = System.IntPtr.Zero;
                DotNet_CesiumForUnity_SelectIonTokenWindow_UseExistingToken(Reinterop.ObjectHandleUtility.CreateHandle(this), _implementation, &reinteropException);
                if (reinteropException != IntPtr.Zero) throw (System.Exception)Reinterop.ObjectHandleUtility.GetObjectAndFreeHandle(reinteropException);
            }
        }
        private partial void SpecifyToken()
        {
            unsafe
            {
                ...
                System.IntPtr reinteropException = System.IntPtr.Zero;
                DotNet_CesiumForUnity_SelectIonTokenWindow_SpecifyToken(Reinterop.ObjectHandleUtility.CreateHandle(this), _implementation, &reinteropException);
                if (reinteropException != IntPtr.Zero) throw (System.Exception)Reinterop.ObjectHandleUtility.GetObjectAndFreeHandle(reinteropException);
            }
        }
        ...
        [DllImport("CesiumForUnityNative", CallingConvention=CallingConvention.Cdecl)]
        private static unsafe extern void DotNet_CesiumForUnity_SelectIonTokenWindow_RefreshTokens(System.IntPtr thiz, CesiumForUnity.SelectIonTokenWindow.ImplementationHandle implementation, System.IntPtr* reinteropException);
        [DllImport("CesiumForUnityNative", CallingConvention=CallingConvention.Cdecl)]
        private static unsafe extern void DotNet_CesiumForUnity_SelectIonTokenWindow_CreateToken(System.IntPtr thiz, CesiumForUnity.SelectIonTokenWindow.ImplementationHandle implementation, System.IntPtr* reinteropException);
        [DllImport("CesiumForUnityNative", CallingConvention=CallingConvention.Cdecl)]
        private static unsafe extern void DotNet_CesiumForUnity_SelectIonTokenWindow_UseExistingToken(System.IntPtr thiz, CesiumForUnity.SelectIonTokenWindow.ImplementationHandle implementation, System.IntPtr* reinteropException);
        [DllImport("CesiumForUnityNative", CallingConvention=CallingConvention.Cdecl)]
        private static unsafe extern void DotNet_CesiumForUnity_SelectIonTokenWindow_SpecifyToken(System.IntPtr thiz, CesiumForUnity.SelectIonTokenWindow.ImplementationHandle implementation, System.IntPtr* reinteropException);
    }
}
#endif
#if UNITY_EDITOR_WIN
