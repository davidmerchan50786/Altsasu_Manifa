    ...
    public partial class IonAssetsTreeView : System.IDisposable
    {
        ...
        public partial int GetAssetsCount()
        {
            unsafe
            {
                ...
                var result = DotNet_CesiumForUnity_IonAssetsTreeView_GetAssetsCount(Reinterop.ObjectHandleUtility.CreateHandle(this), _implementation, &reinteropException);
        ...
        private partial string GetAssetName(int index)
        {
            unsafe
            {
                ...
                System.IntPtr reinteropException = System.IntPtr.Zero;
                var result = DotNet_CesiumForUnity_IonAssetsTreeView_GetAssetName(Reinterop.ObjectHandleUtility.CreateHandle(this), _implementation, index, &reinteropException);
                if (reinteropException != IntPtr.Zero) throw (System.Exception)Reinterop.ObjectHandleUtility.GetObjectAndFreeHandle(reinteropException);
        ...
        private partial string GetAssetType(int index)
        {
            unsafe
            {
                ...
                System.IntPtr reinteropException = System.IntPtr.Zero;
                var result = DotNet_CesiumForUnity_IonAssetsTreeView_GetAssetType(Reinterop.ObjectHandleUtility.CreateHandle(this), _implementation, index, &reinteropException);
                if (reinteropException != IntPtr.Zero) throw (System.Exception)Reinterop.ObjectHandleUtility.GetObjectAndFreeHandle(reinteropException);
                return (string)Reinterop.ObjectHandleUtility.GetObjectAndFreeHandle(result)!;
            }
        }
        private partial long GetAssetID(int index)
        {
            unsafe
            {
                ...
                System.IntPtr reinteropException = System.IntPtr.Zero;
                var result = DotNet_CesiumForUnity_IonAssetsTreeView_GetAssetID(Reinterop.ObjectHandleUtility.CreateHandle(this), _implementation, index, &reinteropException);
                if (reinteropException != IntPtr.Zero) throw (System.Exception)Reinterop.ObjectHandleUtility.GetObjectAndFreeHandle(reinteropException);
                return result;
            }
        }
        private partial string GetAssetDescription(int index)
        {
            unsafe
            {
                ...
                System.IntPtr reinteropException = System.IntPtr.Zero;
                var result = DotNet_CesiumForUnity_IonAssetsTreeView_GetAssetDescription(Reinterop.ObjectHandleUtility.CreateHandle(this), _implementation, index, &reinteropException);
                if (reinteropException != IntPtr.Zero) throw (System.Exception)Reinterop.ObjectHandleUtility.GetObjectAndFreeHandle(reinteropException);
                return (string)Reinterop.ObjectHandleUtility.GetObjectAndFreeHandle(result)!;
            }
        }
        private partial string GetAssetAttribution(int index)
        {
            unsafe
            {
                ...
                System.IntPtr reinteropException = System.IntPtr.Zero;
                var result = DotNet_CesiumForUnity_IonAssetsTreeView_GetAssetAttribution(Reinterop.ObjectHandleUtility.CreateHandle(this), _implementation, index, &reinteropException);
                if (reinteropException != IntPtr.Zero) throw (System.Exception)Reinterop.ObjectHandleUtility.GetObjectAndFreeHandle(reinteropException);
                return (string)Reinterop.ObjectHandleUtility.GetObjectAndFreeHandle(result)!;
            }
        }
        private partial void CellGUI(UnityEngine.Rect cellRect, int assetIndex, CesiumForUnity.IonAssetsColumn column)
        {
            unsafe
            {
                ...
                System.IntPtr reinteropException = System.IntPtr.Zero;
                DotNet_CesiumForUnity_IonAssetsTreeView_CellGUI(Reinterop.ObjectHandleUtility.CreateHandle(this), _implementation, &cellRect, assetIndex, column, &reinteropException);
                if (reinteropException != IntPtr.Zero) throw (System.Exception)Reinterop.ObjectHandleUtility.GetObjectAndFreeHandle(reinteropException);
            }
        }
        public partial void Refresh()
        {
            unsafe
            {
                ...
                System.IntPtr reinteropException = System.IntPtr.Zero;
                DotNet_CesiumForUnity_IonAssetsTreeView_Refresh(Reinterop.ObjectHandleUtility.CreateHandle(this), _implementation, &reinteropException);
                if (reinteropException != IntPtr.Zero) throw (System.Exception)Reinterop.ObjectHandleUtility.GetObjectAndFreeHandle(reinteropException);
            }
        }
        public partial void AddAssetToLevel(int index)
        {
            unsafe
            {
                ...
                System.IntPtr reinteropException = System.IntPtr.Zero;
                DotNet_CesiumForUnity_IonAssetsTreeView_AddAssetToLevel(Reinterop.ObjectHandleUtility.CreateHandle(this), _implementation, index, &reinteropException);
                if (reinteropException != IntPtr.Zero) throw (System.Exception)Reinterop.ObjectHandleUtility.GetObjectAndFreeHandle(reinteropException);
            }
        }
        public partial void AddOverlayToTerrain(int index)
        {
            unsafe
            {
                ...
                System.IntPtr reinteropException = System.IntPtr.Zero;
                DotNet_CesiumForUnity_IonAssetsTreeView_AddOverlayToTerrain(Reinterop.ObjectHandleUtility.CreateHandle(this), _implementation, index, &reinteropException);
                if (reinteropException != IntPtr.Zero) throw (System.Exception)Reinterop.ObjectHandleUtility.GetObjectAndFreeHandle(reinteropException);
            }
        }
        ...
        [DllImport("CesiumForUnityNative", CallingConvention=CallingConvention.Cdecl)]
        private static unsafe extern int DotNet_CesiumForUnity_IonAssetsTreeView_GetAssetsCount(System.IntPtr thiz, CesiumForUnity.IonAssetsTreeView.ImplementationHandle implementation, System.IntPtr* reinteropException);
        [DllImport("CesiumForUnityNative", CallingConvention=CallingConvention.Cdecl)]
        private static unsafe extern System.IntPtr DotNet_CesiumForUnity_IonAssetsTreeView_GetAssetName(System.IntPtr thiz, CesiumForUnity.IonAssetsTreeView.ImplementationHandle implementation, int index, System.IntPtr* reinteropException);
        [DllImport("CesiumForUnityNative", CallingConvention=CallingConvention.Cdecl)]
        private static unsafe extern System.IntPtr DotNet_CesiumForUnity_IonAssetsTreeView_GetAssetType(System.IntPtr thiz, CesiumForUnity.IonAssetsTreeView.ImplementationHandle implementation, int index, System.IntPtr* reinteropException);
        [DllImport("CesiumForUnityNative", CallingConvention=CallingConvention.Cdecl)]
        private static unsafe extern long DotNet_CesiumForUnity_IonAssetsTreeView_GetAssetID(System.IntPtr thiz, CesiumForUnity.IonAssetsTreeView.ImplementationHandle implementation, int index, System.IntPtr* reinteropException);
        [DllImport("CesiumForUnityNative", CallingConvention=CallingConvention.Cdecl)]
        private static unsafe extern System.IntPtr DotNet_CesiumForUnity_IonAssetsTreeView_GetAssetDescription(System.IntPtr thiz, CesiumForUnity.IonAssetsTreeView.ImplementationHandle implementation, int index, System.IntPtr* reinteropException);
        [DllImport("CesiumForUnityNative", CallingConvention=CallingConvention.Cdecl)]
        private static unsafe extern System.IntPtr DotNet_CesiumForUnity_IonAssetsTreeView_GetAssetAttribution(System.IntPtr thiz, CesiumForUnity.IonAssetsTreeView.ImplementationHandle implementation, int index, System.IntPtr* reinteropException);
        [DllImport("CesiumForUnityNative", CallingConvention=CallingConvention.Cdecl)]
        private static unsafe extern void DotNet_CesiumForUnity_IonAssetsTreeView_CellGUI(System.IntPtr thiz, CesiumForUnity.IonAssetsTreeView.ImplementationHandle implementation, UnityEngine.Rect* cellRect, int assetIndex, CesiumForUnity.IonAssetsColumn column, System.IntPtr* reinteropException);
        [DllImport("CesiumForUnityNative", CallingConvention=CallingConvention.Cdecl)]
        private static unsafe extern void DotNet_CesiumForUnity_IonAssetsTreeView_Refresh(System.IntPtr thiz, CesiumForUnity.IonAssetsTreeView.ImplementationHandle implementation, System.IntPtr* reinteropException);
        [DllImport("CesiumForUnityNative", CallingConvention=CallingConvention.Cdecl)]
        private static unsafe extern void DotNet_CesiumForUnity_IonAssetsTreeView_AddAssetToLevel(System.IntPtr thiz, CesiumForUnity.IonAssetsTreeView.ImplementationHandle implementation, int index, System.IntPtr* reinteropException);
        [DllImport("CesiumForUnityNative", CallingConvention=CallingConvention.Cdecl)]
        private static unsafe extern void DotNet_CesiumForUnity_IonAssetsTreeView_AddOverlayToTerrain(System.IntPtr thiz, CesiumForUnity.IonAssetsTreeView.ImplementationHandle implementation, int index, System.IntPtr* reinteropException);
    }
}
#endif
#if UNITY_EDITOR_WIN
