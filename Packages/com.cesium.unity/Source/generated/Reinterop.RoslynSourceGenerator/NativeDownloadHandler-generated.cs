    ...
    internal partial class NativeDownloadHandler : System.IDisposable
    {
        ...
        private partial bool ReceiveDataNative(System.IntPtr data, int dataLength)
        {
            unsafe
            {
                ...
                var result = DotNet_CesiumForUnity_NativeDownloadHandler_ReceiveDataNative(Reinterop.ObjectHandleUtility.CreateHandle(this), _implementation, data, dataLength, &reinteropException);
        ...
        [DllImport("CesiumForUnityNative", CallingConvention=CallingConvention.Cdecl)]
        private static unsafe extern byte DotNet_CesiumForUnity_NativeDownloadHandler_ReceiveDataNative(System.IntPtr thiz, CesiumForUnity.NativeDownloadHandler.ImplementationHandle implementation, System.IntPtr data, int dataLength, System.IntPtr* reinteropException);
    }
}
#endif
